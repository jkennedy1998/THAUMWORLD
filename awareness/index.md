...
[ AWARENESS ] is tracked as a TAG
that is used to represent
when someone knows where you are.

>you hide from one target at a time

A seeing CHARACTER gains a TAG of:
( AWARENESS : TARGET )
when two of the following are true of the TARGET.

## AWARENESS conditions

- TARGET is in sense range to CHARACTER
>see the senses page
