...
## ROLL MAGs
> the numbers
these are what the number representations of each power level are when calculating for POTENCY,or other scaling number range needs. 
> how much healing the potion does, how much damage the sword does, how good of spells can a wand cast 
...
## DAMAGE MAGs
> scaling damage for narration and scale sense
the effect of a MAG of damage and 
often a tell of force, effect potency, or mental damage

the actual ROLL for this damage is 
represented on the ROLL MAGs section above
...
## HARDNESS MAGs
> from clouds to the hardest steels (and onward)
the effect of a MAG of damage and 
often a tell of force, effect potency, or mental damage
...
## CONDUCTIVITY MAGs
> from dampening to full theoretical conductivity
how much THAUM can be pulled through a material at once.

dampening makes you spend that much more thaum, ( useful for armor )
conductivity allows you to cast spells through it ( useful for tools )
