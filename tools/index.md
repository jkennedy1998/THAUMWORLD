...
> ATTACK subtype CLEAVE: roll one RESULT roll for all targets, but with different CHALLENGE RATINGS. distribute potency rolls across multiple targets within range. 

TOOLS have REQUIREMENTS like ARMOR.
If you do not meet the REQUIREMENTS of the TOOL, the tool's MAG counts as improvised / MAG 1 and you cannot use the TOOL's ACTION subtype rulings.
